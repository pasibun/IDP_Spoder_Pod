...
void TFT::drawCharhor( INT8U ascii, INT16U poX, INT16U poY,INT16U size, INT16U fgcolor)
{
    if((ascii>=32)&&(ascii<=127))
    {
        ;
...
void TFT::drawStringhor(char *string,INT16U poX, INT16U poY, INT16U size,INT16U fgcolor)
{
    while(*string)
    {
        drawCharhor(*string, poX, poY, size, fgcolor);
        *string++;
