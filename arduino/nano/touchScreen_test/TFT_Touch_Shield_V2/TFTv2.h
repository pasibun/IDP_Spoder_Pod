...
public:
    ...
    void drawCharhor(INT8U ascii,INT16U poX, INT16U poY,INT16U size, INT16U fgcolor);
    void drawStringhor(char *string,INT16U poX, INT16U poY,INT16U size,INT16U fgcolor);
    void drawStringhor(const char *string,INT16U poX, INT16U poY,INT16U size,INT16U fgcolor)
    {
        drawStringhor((char*)string, poX, poY, size, fgcolor);
    }
